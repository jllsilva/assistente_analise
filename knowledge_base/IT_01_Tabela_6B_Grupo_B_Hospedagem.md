...
Localização: Página 11, Tabela 6B - Edificações do Grupo B com Área Superior a 750 m² ou Altura Superior a 12,00 m

**Ocupação:** GRUPO B – SERVIÇOS DE HOSPEDAGEM (Divisões B-1 e B-2)
...
- **Critério:** Edificação Térrea (Um pavimento)
  ...
  - **Exigência:** Iluminação de Emergência é **Exigido** (Nota: Estão isentos os motéis que não possuam corredores internos de serviço).
  - **Exigência:** Alarme de Incêndio é **Exigido** (Nota: Os acionadores manuais devem ser instalados nas áreas de circulação).
...
- **Critério:** Edificação Baixa (H ≤ 6 m)
  ...
  - **Exigência:** Brigada de Incêndio é **Exigido** (Nota: Incluir Bombeiro Civil conforme Lei Estadual 7.410).
  - **Exigência:** Iluminação de Emergência é **Exigido** (Nota: Estão isentos os motéis que não possuam corredores internos de serviço).
  - **Exigência:** Detecção de incêndio é **Exigido** (Nota: Os detectores de incêndio devem ser instalados em todos os quartos).
  - **Exigência:** Alarme de Incêndio é **Exigido** (Nota: Os acionadores manuais devem ser instalados nas áreas de circulação).
  - **Exigência:** Sinalização de Emergência é **Exigido**.
  - **Exigência:** Extintores é **Exigido**.
  - **Exigência:** Hidrante e Mangotinhos é **Exigido**.
