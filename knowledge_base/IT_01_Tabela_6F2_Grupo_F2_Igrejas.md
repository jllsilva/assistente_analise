...
Localização: Página 16, Tabela 6F(2) - Edificações da Divisão F-2 com Área Superior a 750 m² ou Altura Superior a 12,00 m

**Ocupação:** GRUPO F – REUNIÃO DE PÚBLICO (Divisão F-2 - Igrejas)
...
- **Critério:** Edificação Alta (Acima de 30 metros)
  ...
  - **Exigência:** Extintores é **Exigido**.
  - **Exigência:** Hidrante e Mangotinhos é **Exigido**.
  - **Exigência:** Controle de Fumaça é **Exigido** (Nota: Acima de 90 metros de altura).
